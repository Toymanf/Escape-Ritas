...
char mqttTopicPrefix[64] = "/Egypt/Tomb/espAudio/SFX2/";  //Set to proper listening prefix
char mqttStatus[64] = "/Egypt/Tomb/";                           //Set to proper reporting prefix
char mqttTopic[64];
int Folder = 2;                                                 //Set to proper default folder
...
void setup_wifi() {
  ...
  ArduinoOTA.setHostname("Tomb_Audio_SFX2_OTA");
...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str(), MQTT_USER, MQTT_PASSWORD)) {
      ...
      client.publish(mqttStatus, "Tomb SFX connected. Loading audio");
      // ... and resubscribe
...
void setup()
{
  ...
  client.publish(mqttStatus, "Tomb SFX ready");
}
