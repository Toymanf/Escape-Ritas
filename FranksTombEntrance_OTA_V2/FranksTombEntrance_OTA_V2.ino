...
#define servoPin D7
#define Puzzle_Input D1
#define Lock D5
#define Door D6
#define Handle_Input D2
...
*/
  ...
  */
  ...
  ArduinoOTA.setHostname("Tomb_SlidingPuzzle_OTA");
...
void callback(char* topic, byte *payload, unsigned int length) {
  ...
  if (message == "status") {
    ...
    checkConnection();
    client.publish("/Egypt/Tomb/","Tomb Sliding Puzzle OK");
  }     
  else if (message == "solve"){
    checkConnection();
    Puzzle_Solved=false;    
    client.publish("/Egypt/Tomb/","Tomb Sliding Puzzle Solved Remotely");
  }
